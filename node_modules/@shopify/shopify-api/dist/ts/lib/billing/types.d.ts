...
export type BillingConfigItem = BillingConfigOneTimePlan | BillingConfigSubscriptionLineItemPlan;
/**
...
export type RequestConfigLineItemOverrides = DeepPartial<BillingConfigSubscriptionLineItemPlan>;
...
export type BillingCheckParams<Future extends FutureFlagOptions = FutureFlagOptions> = FeatureEnabled<Future, 'unstable_managedPricingSupport'> extends true ? BillingCheckParamsNew : BillingCheckParamsOld;
...
export type BillingCheckResponse<Params extends BillingCheckParams<Future>, Future extends FutureFlagOptions = FutureFlagOptions> = FeatureEnabled<Future, 'unstable_managedPricingSupport'> extends true ? BillingCheckResponseObject : Params extends BillingCheckParamsOld ? Params['returnObject'] extends true ? BillingCheckResponseObject : boolean : never;
type BillingRequestOverridesType = RequestConfigOverrides & RequestConfigLineItemOverrides;
...
export type UpdateCappedAmountConfirmation = Omit<AppSubscriptionLineItemUpdatePayload, 'userErrors'>;
type AppPlanDiscountAmount = BillingConfigSubscriptionPlanDiscountAmount | BillingConfigSubscriptionPlanDiscountPercentage;
...
export type BillingCheck<Future extends FutureFlagOptions> = <Params extends BillingCheckParams<Future>>(params: Params) => Promise<BillingCheckResponse<Params, Future>>;
export type BillingRequest = <Params extends BillingRequestParams>(params: Params) => Promise<BillingRequestResponse<Params>>;
export type BillingCancel = (params: BillingCancelParams) => Promise<AppSubscription>;
export type BillingSubscriptions = (params: BillingSubscriptionParams) => Promise<ActiveSubscriptions>;
export type BillingCreateUsageRecord = (params: BillingCreateUsageRecordParams) => Promise<UsageRecord>;
export type BillingUpdateUsageCappedAmount = (params: BillingUpdateUsageCappedAmountParams) => Promise<UpdateCappedAmountConfirmation>;
